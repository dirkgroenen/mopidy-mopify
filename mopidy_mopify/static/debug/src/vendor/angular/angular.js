    ...
    <example module="selectExample">
      <file name="index.html">
        ...
        angular.module('selectExample', [])
          .controller('ExampleController', ['$scope', function($scope) {
            $scope.colors = [
              {name:'black', mopify:'dark'},
              {name:'white', mopify:'light'},
              {name:'red', mopify:'dark'},
              {name:'blue', mopify:'dark'},
              {name:'yellow', mopify:'light'}
            ];
        ...
        <div ng-controller="ExampleController">
          ...
          Color grouped by mopify:
          <select ng-model="myColor" ng-options="color.name group by color.mopify for color in colors">
          </select><br/>


          Select <a href ng-click="myColor = { name:'not in list', mopify: 'other' }">bogus</a>.<br>
          <hr/>
