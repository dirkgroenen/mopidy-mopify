...
.factory("mopidyservice", function($q, $rootScope, $cacheFactory, $location, $timeout, Settings, notifier, QueueManager, ModelAssigner){
    ...
    /**
     * Converts raw object data to models
     *
     * @param  {object|array} data
     * @return {object|array}
     */
    function buildModelResponse(data){
        return ModelAssigner.build(data);
    }
